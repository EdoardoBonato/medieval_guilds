...
path = r"C:\Users\edobo\OneDrive\Desktop\Thesis\Medieval Guilds\Data\EDITED_db\duration\merged_duration_imputed1.xlsx"    
...
merged['max_year'] = np.clip(merged['max_year'], None, 1900)
...
merged_sorted['guilds_nr_place'] = merged_sorted.groupby('place')['exist'].cumsum()+ 1


merged_sorted.to_excel(r"C:\Users\edobo\OneDrive\Desktop\Thesis\Medieval Guilds\Data\EDITED_db\duration\guilds_number1.xlsx")