# -*- coding: utf-8 -*-
"""
Created on Sun Dec 10 01:42:38 2023
...
p_main = r"C:\Users\edobo\OneDrive\Desktop\Thesis\Medieval Guilds\Data\EDITED_db\Merge\merging_attempt.xlsx"
main = pd.read_excel(p_main, header = 0)
...
group_by_place = main.groupby('Place')
for group in group_by_place:
    print(group)
main['guilds_nr'] = group_by_place.cumcount() +1 

common_cities = []
for place in main['Place']:
...
guild_pop = pd.merge(main, population, on = 'Place', how = 'inner')
...
guild_pop.to_excel(r"C:\Users\edobo\OneDrive\Desktop\Thesis\Medieval Guilds\Data\EDITED_db\Merge\popilation_robust.xlsx")
'''
